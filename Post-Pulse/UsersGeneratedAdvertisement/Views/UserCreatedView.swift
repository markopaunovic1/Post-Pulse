...
struct UserCreatedView: View {
    ...
    var body: some View {
        NavigationView {
            if userOwnAdViewModel.getUserOwnAd.isEmpty {
                ZStack {
                    ...
                    VStack {
                        ...
                        Text("Inga annonser har lagts till")
                    }
                }
            } else {
                ScrollView {
...
struct UserCreatedViews_Previews: PreviewProvider {
    static var previews: some View {
        UserCreatedView(currentUser: User(id: "1", fullname: "Marko", email: "marko", employment: "marko", phoneNumber: "marko"))
